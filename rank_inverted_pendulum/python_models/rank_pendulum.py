...
# Pendulum imports
from rank_pendulum_machine_vertex import RankPendulumMachineVertex
...
# Pendulum
# ----------------------------------------------------------------------------
class Rank_Pendulum(ApplicationVertex,
    ...
    def get_connections_from_machine(self, transceiver, placement, edge, graph_mapper,
        ...
        super(Rank_Pendulum, self).get_connections_from_machine(transceiver, placement, edge,
    ...
    def add_pre_run_connection_holder(self, connection_holder, projection_edge, synapse_information):
        super(Rank_Pendulum, self).add_pre_run_connection_holder(connection_holder, projection_edge, synapse_information)
    ...
    def create_machine_vertex(self, vertex_slice, resources_required,
        ...
        return RankPendulumMachineVertex(resources_required, constraints, self._label)
    ...
    def generate_data_specification(self, spec, placement, machine_time_step,
        ...
        spec.reserve_memory_region(
            region=RankPendulumMachineVertex._PENDULUM_REGIONS.SYSTEM.value,
            size=front_end_common_constants.SYSTEM_BYTES_REQUIREMENT,
            label='setup')
        spec.reserve_memory_region(
            region=RankPendulumMachineVertex._PENDULUM_REGIONS.PENDULUM.value,
            size=self.PENDULUM_REGION_BYTES, label='PendulumVertex')
        # vertex.reserve_provenance_data_region(spec)
        # reserve recording region
        spec.reserve_memory_region(
            RankPendulumMachineVertex._PENDULUM_REGIONS.RECORDING.value,
            recording_utilities.get_recording_header_size(1))
        spec.reserve_memory_region(
            region=RankPendulumMachineVertex._PENDULUM_REGIONS.DATA.value,
            size=self.DATA_REGION_BYTES, label='PendulumData')

        # Write setup region
        spec.comment("\nWriting setup region:\n")
        spec.switch_write_focus(
            RankPendulumMachineVertex._PENDULUM_REGIONS.SYSTEM.value)
        ...
        spec.switch_write_focus(
            RankPendulumMachineVertex._PENDULUM_REGIONS.PENDULUM.value)
        ...
        spec.switch_write_focus(
            RankPendulumMachineVertex._PENDULUM_REGIONS.DATA.value)
        ip_tags = tags.get_ip_tags_for_vertex(self) or []
